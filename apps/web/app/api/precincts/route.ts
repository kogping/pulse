...
// Only precincts whose Edge Config `precinct_<id>_enabled` flag is on are
// returned — an unlaunched precinct in PRECINCT_REGISTRY must stay
// unreachable even by manual pick, same as it's unreachable by geolocation
// (see /api/location/resolve).
